...
export default ({
  ...
  const navLinks = [
    <NavLinks key={1}>
      <NavLink href={process.env.PUBLIC_URL + "#"}>Features</NavLink>
      <NavLink href={process.env.PUBLIC_URL + "#"}>Pricing</NavLink>
      <NavLink href={process.env.PUBLIC_URL + "#"}>Login</NavLink>
